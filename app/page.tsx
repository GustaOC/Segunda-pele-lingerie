...
export default function EcommerceHome() {
  ...
  return (
    <div className={`min-h-screen bg-slate-50 ${inter.variable} ${playfair.variable} font-sans`}>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8 max-w-xl">
            <div className="inline-flex items-center space-x-2 bg-white/50 backdrop-blur-sm border border-purple-100 px-4 py-2 rounded-full">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider text-[#5D3A5B]">Nova Coleção Outono</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold text-slate-900 leading-[1.1]" style={{ fontFamily: "var(--font-playfair)" }}>
              O Poder <br/> da sua <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5D3A5B] to-purple-500 italic font-medium">Segunda Pele</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/lingeries" className="w-full sm:w-auto">
                <Button size="lg" className="rounded-full bg-[#5D3A5B] hover:bg-[#4A2E49] text-white px-8 h-14 text-base shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 w-full">
                  Ver Lançamentos
                </Button>
              </Link>
              <Link href="/seja-consultora" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="rounded-full border-slate-300 hover:border-[#5D3A5B] text-slate-700 hover:text-[#5D3A5B] px-8 h-14 text-base bg-white/50 backdrop-blur-sm w-full sm:w-auto">
                  Revenda e Lucre
                </Button>
              </Link>
            </div>
            ...
            {products.map((product) => (
              <Link href={`/produto/${product.id}`} key={product.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
                ...
                <div className="relative h-[380px] overflow-hidden bg-slate-100">
                  ...
                  {product.oldPrice && (
                    <div className="absolute top-4 left-4 z-10 bg-pink-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-wider">
                      Oferta
                    </div>
                  )}
                  {isAdmin ? (
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="relative w-full rounded-[3rem] overflow-hidden bg-[#5D3A5B] shadow-2xl">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#5D3A5B] via-[#5D3A5B]/90 to-transparent"></div>
            ...
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <Link href="/seja-consultora">
                  <Button size="lg" className="bg-white text-[#5D3A5B] hover:bg-pink-50 hover:scale-105 transition-all shadow-xl rounded-full h-14 px-8 text-lg font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-pink-500 transition-colors">
