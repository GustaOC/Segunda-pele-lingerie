...
export default function AdminLogin() {
  ...
  const handleForgotPassword = useCallback(async () => {
    ...
    try {
      ...
      setFormError("Erro ao solicitar redefinição de senha")
    }
  }, [formData.email])
  ...
  // Sempre mostrar o formulário, mesmo durante o loading inicial do auth
  return (
    <ShaderBackground>
      <div className={cn(
        ...
        <div className="w-full max-w-md">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-white font-medium font-poppins">
                    Email
                  </Label>
                  <Input
                    id="email"
                ...
                {/* Password Field */}
                <div className="space-y-2">
                  <Label htmlFor="password" className="text-white font-medium font-poppins">
                    Senha
                  </Label>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="rememberMe" className="text-sm text-white font-poppins">
                      Lembrar-me
                    </Label>
                  </div>
                  ...
                  <Button
                    type="button"
                    variant="link"
                    className="px-0 text-sm text-violet-300 hover:text-violet-200 font-poppins"
                ...
                <Button
                  type="submit"
                  className="w-full bg-violet-500 hover:bg-violet-600 text-white font-semibold py-3 shadow-lg font-poppins"
                  disabled={isSubmitting}
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="text-center mt-6">
            <Button
              variant="link"
              onClick={() => router.push("/")}
              className="text-sm text-violet-300 hover:text-violet-200 font-poppins"
              disabled={isSubmitting}
            >
              ← Voltar para o site
            </Button>
